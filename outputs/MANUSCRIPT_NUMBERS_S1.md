# MANUSCRIPT_NUMBERS_S1 — frozen citation manifest (2026-08-16T23:32:43Z, canonical = v2 detector, main @ post-be6d2d2)
...
**Q7 — presentation contrast (schema vs prose vs both): the set did NOT return nothing.** Surviving v2 results: (i) llama4 exit SUPPRESSION by added prose — exit_schema 0.7667 vs exit_both 0.5083 (outputs/T20_llama4_stage2.csv, CONF n=120/cell; same direction three independent runs); (ii) gemma C refusal is schema-gated — exit_schema 14/36 vs exit_prose 0/36 vs exit_both 0/36 (T24, CONF); (iii) gemini C likewise 12/36 vs 0/36 vs 3/36 (T24, CONF; exit_both VERIFIED = 3 against derived/cd_conf_classified.parquet — 3 refusals, 2 exits — and the six conditions sum 0+12+7+12+0+3 = 34, the roman-exclusive total. A '5' reported in accompanying session prose was the superseded pre-adoption value; this manifest has read 3 from T24 since generation. *Was, pre-adoption: 5*); (iv) qwen A exit RATE by channel 39/60 schema vs 20/60 prose vs 39/60 both (T24, CONF) — the channel halves the rate, it no longer switches the outlet. A sentence saying this comparison returned nothing would be WRONG on both outcomes for four models.
